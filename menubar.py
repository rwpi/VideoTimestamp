...
def setup_menu_bar(window):
    ...
    window.run_magic_renamer_when_finished_action = QAction("Run Magic Renamer When Finished", window)
    ...
    window.magic_renamer_action = QAction("Magic Renamer", window)
